...
public class RedstarGoodsNumGreyView extends RelativeLayout {
    ...
    public RedstarGoodsNumGreyView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        View view = inflate(context, R.layout.redstar_goods_num_view_grep_layout, this);
