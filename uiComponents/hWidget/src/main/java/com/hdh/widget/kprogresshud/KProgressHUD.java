...
public class KProgressHUD {
    ...
    private class ProgressDialog extends Dialog {
        ...
        private void initViews() {
            mBackgroundLayout = (BackgroundLayout) findViewById(R.id.progressbar_background);
            ...
            mCustomViewContainer = (FrameLayout) findViewById(R.id.progressbar_container);
            ...
            mLabelText = (TextView) findViewById(R.id.progressbar_label_tv);
            if (mLabel != null) {
            ...
            mDetailsText = (TextView) findViewById(R.id.progressbar_details_tv);
