package com.hdh.pay.unionpay;

import android.app.Activity;
import android.content.Intent;

import com.hdh.pay.HPay;
 ...
 * @since 2017/11/27 10:43
 */
public class UPPay {
    private static UPPay mUPPay;
    private Activity mContext;
    private String mMode;
    private HPay.HPayListener mJPayListener;
    ...
    public void startUPPay(String mode, String tn, HPay.HPayListener listener) {
