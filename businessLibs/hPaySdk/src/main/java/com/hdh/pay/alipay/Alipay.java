...
import com.hdh.pay.HPay.HPayListener;
 ...
 * @since 2017/11/27 10:44
 */
public class Alipay {
    private static Alipay mAliPay;
    private Activity mContext;
    private HPayListener mJPayListener;
    ...
    public void startAliPay(final String orderInfo, HPayListener listener) {
