...
import com.hdh.common.util.app.AppLogMessageMgr;
...
public final class FragmentUtil {
    ...
    public static void addFragment(@NonNull AppCompatActivity activity, Fragment fragment, @IdRes int contentId) {
        activity.getSupportFragmentManager().beginTransaction().add(contentId, fragment).commitAllowingStateLoss();
    }

    public static void addFragment(@NonNull AppCompatActivity activity, Fragment fragment,
                                   @IdRes int contentId, String tag) {
        Fragment fragment1 = activity.getSupportFragmentManager().findFragmentByTag(tag);
        if (fragment1 == null)
            activity.getSupportFragmentManager().beginTransaction().add(contentId,
     ...
     * @param contentId
     */
    public static void switchContent(@NonNull AppCompatActivity activity, Fragment from, Fragment to,
                                     @IdRes int contentId) {
