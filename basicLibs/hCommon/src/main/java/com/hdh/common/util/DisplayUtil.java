...
public class DisplayUtil {
    ...
    public static int getNavigationBarHeight(Context context) {
        ...
        LogUtil.i(LOG_TAG, "Navi height:" + height);
        return height;
    }
    ...
    /**
     * get Screen window displayeMetrcs
     *
     * @param context
     * @return
     */
    ...
    public static RectF getPosition(ImageView view) {
...
//        }
        ...
        mDrawRect.left = width / 5;
        mDrawRect.top = height / 6;
        mDrawRect.right = 4 * width / 5;
        mDrawRect.bottom = 5 * height / 6;


        RectF rectF = new RectF();
        rectF.left = mDrawRect.left / (float) view.getWidth();
        rectF.top = mDrawRect.top / (float) view.getHeight();
        rectF.right = mDrawRect.right / (float) view.getWidth();
        rectF.bottom = mDrawRect.bottom / (float) view.getHeight();
        return rectF;
    }
}
