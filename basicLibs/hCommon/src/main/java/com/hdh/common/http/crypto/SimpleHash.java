...
import com.hdh.common.http.codec.ByteSource;
...
public class SimpleHash extends AbstractHash {
     ...
     * <p/>
     * This is provided <em>ONLY</em> to reconstitute a Hash instance that isNetworkAvailable already been computed.  It should ONLY
