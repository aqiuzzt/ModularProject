...
import com.hdh.common.http.codec.Base64;
import com.hdh.common.http.codec.CodecSupport;
import com.hdh.common.http.codec.Hex;
...
public abstract class AbstractHash extends CodecSupport implements Hash, Serializable {
     ...
     * @throws RuntimeException if the specified {@code source} cannot be converted into a byte array (byte[]).
     */
    public AbstractHash(Object source) throws RuntimeException {
        this(source, null, 1);
    }
     ...
     * @throws RuntimeException if either constructor argument cannot be converted into a byte array.
     */
    public AbstractHash(Object source, Object salt) throws RuntimeException {
        this(source, salt, 1);
    }
     ...
     * types a {@link RuntimeException RuntimeException} will be thrown.
     * <p/>
     ...
     * @throws RuntimeException if either Object constructor argument cannot be converted into a byte array.
     */
    public AbstractHash(Object source, Object salt, int hashIterations) throws RuntimeException {
