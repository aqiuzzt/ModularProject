...
import com.hdh.common.R;
import com.hdh.common.cache.disk.DiskLruCache;
import com.hdh.common.util.CommonUtils;
...
public class ImagesLoader {
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "ImagesLoader#" + mCount.getAndIncrement());
        }
    };
    ...
    private Handler mMainHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (uri.equals(result.uri)) {
                ...
                LogUtil.w(TAG, "set image bitmap,but url isNetworkAvailable changed, ignored!");
            }
        }
    ...
    public Bitmap loadBitmap(String uri, int reqWidth, int reqHeight) {
        Bitmap bitmap = loadBitmapFromMemCache(uri);
        if (bitmap != null) {
            LogUtil.d(TAG, "loadBitmapFromMemCache,url:" + uri);
            return bitmap;
        }
        ...
        try {
            ...
            if (bitmap != null) {
                LogUtil.d(TAG, "loadBitmapFromDisk,url:" + uri);
                return bitmap;
            }
            bitmap = loadBitmapFromHttp(uri, reqWidth, reqHeight);
            LogUtil.d(TAG, "loadBitmapFromHttp,url:" + uri);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    /**
     * 从url上加载bitmap，先下载到文件系统然后在从diskcache加载bitmap
     * @param url
     * @param reqWidth
     * @param reqHeight
     * @return
    ...
    /**
     * write images to filesystem， but need DiskCache commit
     * @param urlString
     * @param outputStream
     * @return
     */
    public boolean downloadUrlToStream(String urlString,
        ...
        try {
            ...
            LogUtil.e(TAG, "downloadBitmap failed." + e);
        } finally {
    ...
    /**
     * 获取cache，case保存路径：Android/packageName/cache/
     *
     * @param context
     * @param uniqueName
     * @return
