...
public class WordUtil {
    ...
    public WordUtil(String doc_name) {
        docPath = doc_name;
        htmlPath = WordFileUtil.createFile("html", WordFileUtil.getFileName(docPath) + ".html");
...
//						}
    ...
    public void writeDocumentPicture(byte[] pictureBytes) {
        picturePath = WordFileUtil.createFile("html", WordFileUtil.getFileName(docPath) + presentPicture + ".jpg");
